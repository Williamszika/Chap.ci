...
function avisDeclenchements(S: Vals) {
...
const MARQUES_ACC = ['Oraimo','Anker','Samsung','Apple','Baseus','Xiaomi','Tecno','Infinix','Itel','Sans marque','Autre marque']
...
const SCHEMAS: Record<string, SchemaSous> = {
  'Smartphones': {
    ...
    titre: function (S: Vals) { return [S.marque !== 'Autre marque' ? S.marque : '', S.modele === 'Autre modèle' ? S.modeleLibre : S.modele, S.stockage].filter(Boolean).join(' ') },
    champs: [
      ...
      { k:'garantie', l:'Sous garantie', t: 'toggle' as const, varOK:true }
    ]
  },
  ...
  'Téléphones fixes': {
    couleurs: true, etat: true, livraison: true,
    titre: function (S: Vals) { return [S.marque !== 'Autre marque' ? S.marque : '', S.modele === 'Autre modèle' ? S.modeleLibre : S.modele, S.typeFixe].filter(Boolean).join(' ') },
    champs: [
      ...
      { k:'combines', l:'Nombre de combinés', o:['1','2','3','4 et plus'], when:function (S: Vals) { return S.typeFixe === 'Sans fil (DECT)' } },
  ...
  'Accessoires téléphone': {
    couleurs: true, etat: true, livraison: true,
    titre: function (S: Vals) { return [S.typeAcc, S.marque && S.marque !== 'Autre marque' && S.marque !== 'Sans marque' ? S.marque : '', S.compatible].filter(Boolean).join(' — ') },
    champs: [
      { k:'typeAcc', l:'Type d’accessoire', o:TYPES_ACC, req:true },
      { k:'marque', l:'Marque', o:MARQUES_ACC, req:true },
      { k:'compatible', l:'Compatible avec', t: 'text' as const, ph:'Ex : iPhone 13, tous Android, USB-C', req:true,
      ...
      { k:'puissance', l:'Puissance', o:['5 W','10 W','18 W','20 W','25 W','33 W','45 W','65 W et plus'],
        when:function (S: Vals) { return /Chargeur/.test(S.typeAcc) } },
      { k:'capacite', l:'Capacité', o:['5 000 mAh','10 000 mAh','20 000 mAh','30 000 mAh et plus'],
        when:function (S: Vals) { return S.typeAcc === 'Powerbank' || S.typeAcc === 'Batterie de remplacement' } },
      { k:'go', l:'Capacité', o:['16 Go','32 Go','64 Go','128 Go','256 Go','512 Go'],
        when:function (S: Vals) { return S.typeAcc === 'Carte mémoire' } },
      { k:'sansFil', l:'Sans fil / Bluetooth', t: 'toggle' as const,
        when:function (S: Vals) { return /Écouteurs|Casque|Clavier/.test(S.typeAcc) } },
      authenticite('Un chargeur ou un écouteur de marque'),
      { k:'lot', l:'Vendu par lot', t: 'toggle' as const, h:'Cochez si vous vendez en gros : l’acheteur revendeur le cherche.' },
  ...
  'Réparation & Dépannage': {
    ...
    champs: [
      ...
      { k:'atelier', l:'Vous recevez en atelier', t: 'toggle' as const },
      { k:'dom', l:'Vous vous déplacez à domicile', t: 'toggle' as const },
      { k:'devis', l:'Devis gratuit', t: 'toggle' as const }
    ]
  }
,
  ...
  'Ordinateurs': {
    ...
    champs: [
      ...
      { k:'generation', l:'Génération du processeur', req:true,
        when:function (S: Vals) { return /^Intel Core i/.test(S.processeur || '') },
      ...
      { k:'ecranPouces', l:'Taille de l’écran',
        when:function (S: Vals) { return /Portable|Tout-en-un|Chromebook|Tablette/.test(S.typeOrdi || '') },
      ...
      { k:'carteGraphique', l:'Carte graphique',
        when:function (S: Vals) { return !/Serveur/.test(S.typeOrdi || '') },
      ...
      { k:'clavier', l:'Disposition du clavier', req:true,
        when:function (S: Vals) { return /Portable|Tout-en-un|Chromebook|Tablette|Station/.test(S.typeOrdi || '') },
      ...
      { k:'batterie', l:'Autonomie de la batterie', req:true,
        when:function (S: Vals) { return /Portable|Chromebook|Tablette/.test(S.typeOrdi || '') },
      ...
      { k:'chargeur', l:'Chargeur', req:true,
        when:function (S: Vals) { return /Portable|Chromebook|Tablette|Mini-PC/.test(S.typeOrdi || '') },
  ...
  'TV & Écrans': {
    ...
    titre: function (S: Vals) { return [S.typeEcran, S.marqueTV, S.pouces, S.resolution].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'refTV', l:'Référence exacte', t: 'text' as const, ph:'Ex : UA43T5300, 43UM7050',
      ...
      { k:'pouces', l:'Taille de la dalle', req:true,
        when:function (S: Vals) { return S.typeEcran !== 'Vidéoprojecteur' },
      ...
      { k:'smart', l:'Connectée ou non', req:true,
        when:function (S: Vals) { return S.typeEcran === 'Téléviseur' },
      ...
      voltage(),
      { k:'regulateur', l:'Régulateur de tension fourni', t: 'toggle' as const,
  ...
  'Audio & Son': {
    ...
    couleurs: function (S: Vals) { return /Enceinte Bluetooth|Casque|Écouteurs|Radio|Enceinte connectée/.test(S.typeAudio || '') },
    ...
    titre: function (S: Vals) { return [S.typeAudio, S.marqueAudio, S.puissance ? S.puissance + ' W' : ''].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'refAudio', l:'Modèle', t: 'text' as const, ph:'Ex : Flip 6, SRM450, WH-1000XM4' },

      authenticite('Un JBL'),

      { k:'puissance', l:'Puissance', t: 'num' as const, unite:'W', ph:'Ex : 300',
        when:function (S: Vals) { return /Sono|Ampli|Enceinte|Barre|Home cinéma|Caisson/.test(S.typeAudio || '') },
      ...
      voltage(),
      { k:'autonomie', l:'Autonomie annoncée', t: 'num' as const, unite:'h', ph:'Ex : 12',
        when:function (S: Vals) { return /Batterie/.test(S.alimentation || '') } },
      { k:'connexions', l:'Connexions', multi:true,
        o:['Bluetooth','Jack 3,5 mm','USB','Carte SD','Radio FM','Optique','XLR','RCA','Wi-Fi','NFC'] },
      { k:'microFourni', l:'Micro(s) fourni(s)', t: 'toggle' as const,
        when:function (S: Vals) { return /Sono|Ampli|Table de mixage/.test(S.typeAudio || '') } },
  ...
  'Jeux vidéo': {
    etat: true, livraison: true,
    couleurs: function (S: Vals) { return /Console|Manette|Accessoire/.test(S.typeJeu || '') },
    sansCouleur: 'Un jeu n’a pas de couleur. Photographiez la jaquette, le disque, et le dos de la boîte.',
    titre: function (S: Vals) { return [S.modeleConsole || S.plateforme, S.typeJeu === 'Jeu (disque ou boîte)' ? S.refJeu : '', S.stockageConsole].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'modeleConsole', l:'Modèle exact', req:true, dependDe:'plateforme', libre:'Autre',
        when:function (S: Vals) { return S.typeJeu === 'Console' },
        table:{
      ...
      { k:'refJeu', l:'Titre du jeu', t: 'text' as const, ph:'Ex : EA FC 26, GTA V',
        when:function (S: Vals) { return S.typeJeu === 'Jeu (disque ou boîte)' }, req:true },
      ...
      { k:'drift', l:'État des sticks (drift)', req:true,
        when:function (S: Vals) { return S.typeJeu === 'Manette' || (S.typeJeu === 'Console' && !!S.manettes && S.manettes !== 'Aucune') },
      ...
      { k:'region', l:'Zone / région',
        when:function (S: Vals) { return /Console|Jeu/.test(S.typeJeu || '') },
      ...
      { k:'langueJeu', l:'Langue',
        when:function (S: Vals) { return S.typeJeu === 'Jeu (disque ou boîte)' },
        o:['Français','Anglais','Multilingue','Japonais'] },
      { k:'boiteJeu', l:'Boîte et notice d’origine', t: 'toggle' as const },
  ...
  'Appareils photo': {
    etat: true, livraison: true,
    couleurs: function (S: Vals) { return /Instantané|Compact|Caméra d’action/.test(S.typeAppareil || '') },
    ...
    champs: [
      ...
      { k:'declenchements', l:'Nombre de déclenchements', t: 'num' as const, ph:'Ex : 24000', req:true,
        when:function (S: Vals) { return /Reflex|Hybride/.test(S.typeAppareil || '') },
      ...
      { k:'capteur', l:'Taille du capteur',
        when:function (S: Vals) { return /Reflex|Hybride|Compact|Bridge/.test(S.typeAppareil || '') },
        o:['Plein format (24×36)','APS-C','Micro 4/3','1 pouce','Petit capteur'] },
      { k:'megapixels', l:'Résolution', t: 'num' as const, unite:'Mpx', ph:'Ex : 24',
        when:function (S: Vals) { return !/Objectif seul|Accessoire/.test(S.typeAppareil || '') } },
      ...
      { k:'objectifs', l:'Lesquels', t: 'text' as const, ph:'Ex : 50 mm f/1.8, 18-135 mm',
        when:function (S: Vals) { return S.objectifFourni === 'Avec un ou plusieurs objectifs' } },
      { k:'monture', l:'Monture', req:true,
        when:function (S: Vals) { return S.typeAppareil === 'Objectif seul' },
      ...
      { k:'stabilisation', l:'Stabilisation', t: 'toggle' as const,
        when:function (S: Vals) { return !/Objectif seul|Accessoire|Instantané/.test(S.typeAppareil || '') } },
      { k:'video', l:'Vidéo',
        when:function (S: Vals) { return !/Objectif seul|Accessoire|Instantané/.test(S.typeAppareil || '') },
  ...
  'Accessoires informatiques': {
    etat: true, livraison: true,
    couleurs: function (S: Vals) { return /Clavier|Souris|Casque|Sacoche|Clé USB|Webcam|Support/.test(S.typeAcc || '') },
    sansCouleur: function (S: Vals) {
    ...
    titre: function (S: Vals) { return [S.typeAcc, S.marqueAcc, S.capaciteAcc, S.disposition].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'marqueAcc', l:'Marque', t: 'text' as const, ph:'Ex : Logitech, HP, SanDisk, sans marque' },
      ...
      { k:'compatible', l:'Compatible avec', req:true, multi:true,
        ...
        when:function (S: Vals) { return !/Onduleur|Câble|Sacoche|Support|Encre|Switch|Composant/.test(S.typeAcc || '') },
      ...
      { k:'disposition', l:'Disposition du clavier', req:true,
        when:function (S: Vals) { return S.typeAcc === 'Clavier' },
      ...
      { k:'connexion', l:'Connexion',
        when:function (S: Vals) { return !/Encre|Composant|Sacoche|Onduleur|Support/.test(S.typeAcc || '') },
        o:['USB-A','USB-C','Sans fil (dongle USB)','Bluetooth','Filaire PS/2','Réseau (RJ45)','Wi-Fi','Jack 3,5 mm'] },
      { k:'capaciteAcc', l:'Capacité', req:true,
        when:function (S: Vals) { return /Disque dur externe|Clé USB|Carte mémoire/.test(S.typeAcc || '') },
      ...
      { k:'typeImprimante', l:'Type d’imprimante', req:true,
        when:function (S: Vals) { return S.typeAcc === 'Imprimante' },
      ...
      { k:'puissanceOnduleur', l:'Puissance', t: 'num' as const, unite:'VA', ph:'Ex : 650',
        when:function (S: Vals) { return S.typeAcc === 'Onduleur / régulateur' },
...
export const ELECTRONIQUE: DonneesCat = {
  sous: SOUS,
