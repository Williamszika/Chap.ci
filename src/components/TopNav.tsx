    ...
    <header className="sticky top-0 z-40 hidden border-b border-line bg-cream-200/85 backdrop-blur-md md:block">
      <div className="mx-auto flex max-w-[1280px] items-center gap-3 px-4 py-3 lg:gap-5 lg:px-6">
        ...
        <Link
          to="/favoris"
          aria-label="Favoris"
          className="relative grid h-11 w-11 shrink-0 place-items-center rounded-full border border-line2 bg-white text-gray-600 transition md:hover:bg-cream-100"
        >
          <Heart size={19} />
          {favorites.length > 0 && (
