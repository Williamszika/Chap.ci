...
const Map<String, Map<String, String>> _secteursPro = {
  ...
  // Ajoutés le 07/09/2026 : secteurs nouveaux dans les types existants…
  'Coiffure & Esthétique': {'en': 'Hairdressing & Beauty', 'es': 'Peluquería y estética', 'pt': 'Cabeleireiro e estética', 'ar': 'حلاقة وتجميل', 'zh': '美发美容'},
  'Auto-école': {'en': 'Driving school', 'es': 'Autoescuela', 'pt': 'Escola de condução', 'ar': 'مدرسة قيادة', 'zh': '驾校'},
  'Université & grande école': {'en': 'University & college', 'es': 'Universidad y escuela superior', 'pt': 'Universidade e escola superior', 'ar': 'جامعة ومعهد عالٍ', 'zh': '大学与高等院校'},
  'Crèche & maternelle': {'en': 'Nursery & kindergarten', 'es': 'Guardería y preescolar', 'pt': 'Creche e pré-escola', 'ar': 'حضانة وروضة', 'zh': '托儿所与幼儿园'},
  'Pharmacie': {'en': 'Pharmacy', 'es': 'Farmacia', 'pt': 'Farmácia', 'ar': 'صيدلية', 'zh': '药房'},
  'Clinique & cabinet médical': {'en': 'Clinic & medical practice', 'es': 'Clínica y consultorio', 'pt': 'Clínica e consultório', 'ar': 'عيادة ومركز طبي', 'zh': '诊所与医务室'},
  // … et les cinq types nouveaux.
  'Restaurant': {'en': 'Restaurant', 'es': 'Restaurante', 'pt': 'Restaurante', 'ar': 'مطعم', 'zh': '餐厅'},
  'Maquis & bar': {'en': 'Maquis & bar', 'es': 'Maquis y bar', 'pt': 'Maquis e bar', 'ar': 'مقهى شعبي وبار', 'zh': '大排档与酒吧'},
  'Traiteur & événements': {'en': 'Catering & events', 'es': 'Catering y eventos', 'pt': 'Catering e eventos', 'ar': 'تموين ومناسبات', 'zh': '外烩与活动餐饮'},
  'Boulangerie & pâtisserie': {'en': 'Bakery & pastry', 'es': 'Panadería y pastelería', 'pt': 'Padaria e pastelaria', 'ar': 'مخبز وحلويات', 'zh': '面包房与糕点'},
  'Fast-food & livraison': {'en': 'Fast food & delivery', 'es': 'Comida rápida y entrega', 'pt': 'Fast-food e entregas', 'ar': 'وجبات سريعة وتوصيل', 'zh': '快餐与外卖'},
  'Épicerie & supermarché': {'en': 'Grocery & supermarket', 'es': 'Tienda y supermercado', 'pt': 'Mercearia e supermercado', 'ar': 'بقالة وسوبرماركت', 'zh': '杂货与超市'},
  'Boissons & glaces': {'en': 'Drinks & ice cream', 'es': 'Bebidas y helados', 'pt': 'Bebidas e gelados', 'ar': 'مشروبات ومثلجات', 'zh': '饮品与冰淇淋'},
  'Hôtel': {'en': 'Hotel', 'es': 'Hotel', 'pt': 'Hotel', 'ar': 'فندق', 'zh': '酒店'},
  'Résidence meublée': {'en': 'Furnished residence', 'es': 'Residencia amueblada', 'pt': 'Residência mobilada', 'ar': 'شقة مفروشة', 'zh': '家具公寓'},
  'Auberge & maison d’hôtes': {'en': 'Inn & guesthouse', 'es': 'Albergue y casa de huéspedes', 'pt': 'Albergue e casa de hóspedes', 'ar': 'نُزل وبيت ضيافة', 'zh': '旅馆与民宿'},
  'Location de vacances': {'en': 'Holiday rental', 'es': 'Alquiler vacacional', 'pt': 'Alojamento de férias', 'ar': 'إيجار عطلات', 'zh': '度假出租'},
  'Salle & espace événementiel': {'en': 'Event venue', 'es': 'Sala y espacio para eventos', 'pt': 'Sala e espaço de eventos', 'ar': 'قاعة مناسبات', 'zh': '活动场地'},
  'Animalerie': {'en': 'Pet shop', 'es': 'Tienda de animales', 'pt': 'Loja de animais', 'ar': 'متجر حيوانات', 'zh': '宠物店'},
  'Clinique vétérinaire': {'en': 'Veterinary clinic', 'es': 'Clínica veterinaria', 'pt': 'Clínica veterinária', 'ar': 'عيادة بيطرية', 'zh': '兽医诊所'},
  'Élevage & vente d’animaux': {'en': 'Breeding & animal sales', 'es': 'Cría y venta de animales', 'pt': 'Criação e venda de animais', 'ar': 'تربية وبيع حيوانات', 'zh': '养殖与动物销售'},
  'Toilettage & pension': {'en': 'Grooming & boarding', 'es': 'Peluquería canina y guardería', 'pt': 'Tosquia e hotel para animais', 'ar': 'تجميل وإيواء حيوانات', 'zh': '宠物美容与寄养'},
  'Alimentation animale': {'en': 'Animal feed', 'es': 'Alimentación animal', 'pt': 'Alimentação animal', 'ar': 'أعلاف', 'zh': '动物饲料'},
  'Banque': {'en': 'Bank', 'es': 'Banco', 'pt': 'Banco', 'ar': 'بنك', 'zh': '银行'},
  'Microfinance': {'en': 'Microfinance', 'es': 'Microfinanzas', 'pt': 'Microfinanças', 'ar': 'تمويل أصغر', 'zh': '小额信贷'},
  'Assurance': {'en': 'Insurance', 'es': 'Seguros', 'pt': 'Seguros', 'ar': 'تأمين', 'zh': '保险'},
  'Mobile Money & transfert': {'en': 'Mobile Money & transfers', 'es': 'Mobile Money y transferencias', 'pt': 'Mobile Money e transferências', 'ar': 'موبايل موني وتحويلات', 'zh': '移动支付与转账'},
  'Prêt & crédit': {'en': 'Loans & credit', 'es': 'Préstamos y crédito', 'pt': 'Empréstimos e crédito', 'ar': 'قروض وائتمان', 'zh': '贷款与信贷'},
  'Agence de communication': {'en': 'Communication agency', 'es': 'Agencia de comunicación', 'pt': 'Agência de comunicação', 'ar': 'وكالة اتصال', 'zh': '传播公司'},
  'Presse & médias': {'en': 'Press & media', 'es': 'Prensa y medios', 'pt': 'Imprensa e média', 'ar': 'صحافة وإعلام', 'zh': '新闻与媒体'},
  'Imprimerie & signalétique': {'en': 'Printing & signage', 'es': 'Imprenta y rotulación', 'pt': 'Gráfica e sinalética', 'ar': 'طباعة ولافتات', 'zh': '印刷与标识'},
  'Photo & vidéo': {'en': 'Photo & video', 'es': 'Foto y vídeo', 'pt': 'Foto e vídeo', 'ar': 'تصوير وفيديو', 'zh': '摄影摄像'},
  'Marketing digital & influence': {'en': 'Digital marketing & influencers', 'es': 'Marketing digital e influencers', 'pt': 'Marketing digital e influenciadores', 'ar': 'تسويق رقمي ومؤثرون', 'zh': '数字营销与网红'},
};
