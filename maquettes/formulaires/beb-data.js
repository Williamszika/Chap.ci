...
var SOUS = ['Vêtements bébé & enfant', 'Poussettes & Sièges auto', 'Mobilier & Chambre',
...
var AGES = ['Naissance (0-1 mois)','1 à 3 mois','3 à 6 mois','6 à 12 mois','12 à 18 mois','18 à 24 mois','2 à 3 ans','3 à 5 ans','5 à 8 ans','8 à 12 ans']
...
var SCHEMAS = {
  ...
  'Vêtements bébé & enfant': {
    ...
    titre: function (S) { return [S.typeVetB, (S.tailleB || []).length ? (S.tailleB.length <= 2 ? S.tailleB.join(', ') : S.tailleB.length + ' tailles') : '', S.pourQuiB].filter(Boolean).join(' · ') },
    champs: [
  ...
  'Poussettes & Sièges auto': {
    ...
    titre: function (S) { return [S.typePouss, S.marqueB, S.groupeSiege].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'marqueB', l:'Marque', t:'text', req:true, ph:'Ex : Chicco, Bébé Confort, sans marque',
      ...
      { k:'choc', l:'A-t-il subi un choc ou un accident ?', req:true,
        when:function (S) { return /Siège auto|Cosy|Rehausseur/.test(S.typePouss || '') },
      ...
      { k:'anneeFab', l:'Année de fabrication', t:'text', ph:'Ex : 2022',
        when:function (S) { return /Siège auto|Cosy|Rehausseur/.test(S.typePouss || '') },
      ...
      { k:'pliage', l:'Pliage',
        when:function (S) { return /Poussette|Combiné/.test(S.typePouss || '') },
  ...
  'Mobilier & Chambre': {
    ...
    titre: function (S) { return [S.typeMobB, S.marqueB, S.dimsB].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'marqueB', l:'Marque', t:'text', ph:'Ex : Ikea, fabrication locale' },

      // Le second champ qui refuse l'annonce.
      { k:'barreaux', l:'Écartement des barreaux', req:true,
        when:function (S) { return /Lit à barreaux|Berceau|Lit évolutif|Parc/.test(S.typeMobB || '') },
      ...
      rappel(),
      { k:'dimsB', l:'Dimensions', t:'text', req:true, ph:'Ex : 120 × 60 cm',
  ...
  'Jouets & Éveil': {
    ...
    titre: function (S) { return [S.typeJouet, S.ageJ, S.nbJouets].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'marqueB', l:'Marque', t:'text', ph:'Ex : Fisher-Price, Lego, sans marque' }
    ]
  },
  ...
  'Puériculture & Repas': {
    couleurs: true, etat: true, livraison: true, prixLabel: 'Prix',
    aideCouleurs: 'Cochez chaque couleur disponible.',
    titre: function (S) { return [S.typePueri, S.marqueB].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'marqueB', l:'Marque', t:'text', ph:'Ex : Philips Avent, Béaba, sans marque' },
      ...
      { k:'peremptionB', l:'Date limite', req:true,
        when:function (S) { return /Biberon|Couches|Assiette/.test(S.typePueri || '') },
      ...
      { k:'electriqueB', l:'Fonctionnement', req:true,
        when:function (S) { return /Chauffe|Stérilisateur|Tire-lait|Robot|Moniteur|Balance|Humidificateur|Veilleuse/.test(S.typePueri || '') },
  ...
  'Vêtements de maternité': {
    ...
    titre: function (S) { return [S.typeMat, (S.tailleMat || []).join('/')].filter(Boolean).join(' · ') },
    champs: [
