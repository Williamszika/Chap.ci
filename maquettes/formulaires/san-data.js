...
var SOUS = ['Compléments & Tisanes', 'Soins & Hygiène', 'Matériel médical de confort',
...
var SCHEMAS = {
  ...
  'Compléments & Tisanes': {
    ...
    titre: function (S) { return [S.typeComp, S.marqueS, S.contenanceS].filter(Boolean).join(' · ') },
    champs: [
      ...
      medicament(),
      promesse(),
      { k:'plante', l:'Plante ou principe', t:'text', ph:'Ex : moringa, kinkeliba, gingembre, curcuma',
        h:'Nommez la plante précisément : c’est ce que l’acheteur tape dans la recherche.' },
      { k:'marqueS', l:'Marque ou producteur', t:'text', ph:'Ex : préparation artisanale, marque connue' },
      { k:'contenanceS', l:'Contenance', t:'text', req:true, ph:'Ex : 60 gélules, 250 g, 50 cl' },
      scelle(), peremptionS(),
  ...
  'Soins & Hygiène': {
    ...
    titre: function (S) { return [S.typeSoin, S.marqueS, S.contenanceS].filter(Boolean).join(' · ') },
    champs: [
      ...
      eclaircissant(),
      promesse(),
      { k:'marqueS', l:'Marque', t:'text', ph:'Ex : Dudu Osun, artisanal, Nivea' },
      { k:'contenanceS', l:'Contenance', t:'text', req:true, ph:'Ex : 250 ml, 100 g, lot de 3' },
      scelle(), peremptionS(),
  ...
  'Matériel médical de confort': {
    ...
    titre: function (S) { return [S.typeMatS, S.marqueS].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'poidsMaxS', l:'Poids supporté',
        when:function (S) { return /Fauteuil|Déambulateur|Chaise percée|Barre/.test(S.typeMatS || '') },
      ...
      { k:'etalonnage', l:'Étalonnage',
        when:function (S) { return /Tensiomètre|Glucomètre|Oxymètre|Balance|Thermomètre/.test(S.typeMatS || '') },
  ...
  'Optique & Audition': {
    ...
    titre: function (S) { return [S.typeOpt, S.marqueS].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'marqueS', l:'Marque', t:'text', ph:'Ex : Ray-Ban, sans marque' },
      { k:'uv', l:'Protection UV',
        when:function (S) { return /soleil/.test(S.typeOpt || '') },
      ...
      { k:'hygieneOpt', l:'Hygiène', req:true,
        when:function (S) { return /auditif/.test(S.typeOpt || '') },
  ...
  'Bien-être & Massage': {
    ...
    titre: function (S) { return [S.typeBien, S.marqueS].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'lieuB', l:'Où', multi:true,
        when:function (S) { return /Oui/.test(S.prestationB || '') },
      ...
      { k:'contenanceS', l:'Contenance', t:'text',
        when:function (S) { return /huile|encens|bougie|Diffuseur/i.test(S.typeBien || '') }, ph:'Ex : 100 ml' },
      scelle(), peremptionS()
    ]
  },
  ...
  'Nutrition sportive': {
    ...
    titre: function (S) { return [S.typeNut, S.marqueS, S.contenanceS].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'marqueS', l:'Marque', t:'text', ph:'Ex : Optimum Nutrition, sans marque' },
      { k:'contenanceS', l:'Contenance', t:'text', req:true, ph:'Ex : 2 kg, 90 gélules' },
      { k:'gout', l:'Parfum', t:'text', ph:'Ex : chocolat, vanille, fraise' },
      scelle(), peremptionS(),
