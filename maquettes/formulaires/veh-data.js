...
var SOUS = ['Voitures', 'Motos & Scooters', 'Camions & Utilitaires', 'Engins & Agricoles', 'Pièces & Accessoires', 'Bateaux', 'Location']
...
var TYPES_CAMION = ['Benne','Fourgon','Plateau','Citerne','Frigorifique','Porte-conteneur','Tracteur routier','Grue / plateau grue','Malaxeur (toupie)','Pick-up','Minibus','Autocar','Ambulance','Dépanneuse','Autre']
...
/* --- Bateaux -------------------------------------------------------------- */
var TYPES_BATEAU = ['Pirogue','Barque','Hors-bord','Semi-rigide','Vedette','Yacht','Jet-ski','Chalutier','Bateau de pêche','Autre']
 ...
 *  l'avertissement.
 */
function moyenneAnnuelle(S, valeur, annee, unite, parAn) {
...
function elec(S) { return S.carburant === '100 % électrique' || S.carburant === 'Hybride rechargeable' }

/* Le dossier administratif — commun aux véhicules immatriculés. */
function dossierVehicule(quoi) {
  return [
...
var SCHEMAS = {
  'Voitures': {
    ...
    champs: [
      ...
      { k:'km', l:'Kilométrage au compteur', t:'num', ph:'Ex : 120000', req:true, unite:'km',
        h:function (S) {
          return moyenneAnnuelle(S, S.km, S.annee, 'km', 15000) ||
      ...
      { k:'autonomie', l:'Autonomie annoncée', t:'num', unite:'km', ph:'Ex : 350', req:true,
      ...
      { k:'boite', l:'Boîte de vitesse', o:['Manuelle','Automatique'], req:true,
        when:function (S) { return S.carburant !== '100 % électrique' } },
    ...
    ].concat(dossierVehicule('la voiture'))
  },

  'Motos & Scooters': {
    couleurs: true, etat: true, livraison: false,
    titre: function (S) { return [S.marque !== 'Autre marque' ? S.marque : '', S.modele === 'Autre modèle' ? S.modeleLibre : S.modele, S.cylindree].filter(Boolean).join(' ') },
    champs: [
      ...
      { k:'cylindree', l:'Cylindrée', req:true,
        ...
        when:function (S) { return !/électrique/i.test(S.typeMoto || '') } },
      { k:'autonomieMoto', l:'Autonomie annoncée', t:'num', unite:'km', ph:'Ex : 80', req:true,
        when:function (S) { return /électrique/i.test(S.typeMoto || '') } },
      ...
      { k:'km', l:'Kilométrage au compteur', t:'num', ph:'Ex : 15000', req:true, unite:'km',
        h:function (S) {
          return moyenneAnnuelle(S, S.km, S.annee, 'km', 12000) ||
    ...
    ].concat(dossierVehicule('la moto'))
  },

  'Camions & Utilitaires': {
    couleurs: true, etat: true, livraison: false,
    titre: function (S) { return [S.marque !== 'Autre marque' ? S.marque : '', S.modele === 'Autre modèle' ? S.modeleLibre : S.modele, S.typeCamion].filter(Boolean).join(' ') },
    champs: [
      ...
      { k:'km', l:'Kilométrage au compteur', t:'num', ph:'Ex : 250000', req:true, unite:'km',
        h:function (S) {
          return moyenneAnnuelle(S, S.km, S.annee, 'km', 40000) ||
    ...
    ].concat(dossierVehicule('le véhicule'))
  },

  'Engins & Agricoles': {
    couleurs: true, etat: true, livraison: false,
    titre: function (S) { return [S.typeEngin, S.marqueEngin, S.anneeEngin].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'modeleEngin', l:'Modèle', t:'text', ph:'Ex : 5075E, 320D, 3CX' },
      { k:'anneeEngin', l:'Année', o:['2026','2025','2024','2023','2022','2021','2020','2019','2018','2017','2016','2015','2014','2013','2012','2011','2010 et avant'] },
      { k:'heures', l:'Heures de fonctionnement', t:'num', unite:'h', ph:'Ex : 4500', req:true,
        h:function (S) {
          return moyenneAnnuelle(S, S.heures, S.anneeEngin, 'heures', 800) ||
            'Sur un engin, l’heure compte plus que le kilomètre. C’est le premier chiffre que demande un acheteur professionnel.'
        } },
      { k:'kmEngin', l:'Kilométrage au compteur', t:'num', unite:'km', ph:'Ex : 60000',
        h:function (S) {
          return moyenneAnnuelle(S, S.kmEngin, S.anneeEngin, 'km', 10000) ||
  ...
  'Pièces & Accessoires': {
    ...
    titre: function (S) { return [S.typePiece, S.compatible].filter(Boolean).join(' — ') },
    champs: [
      { k:'typePiece', l:'Type de pièce', o:TYPES_PIECE, req:true },
      { k:'compatible', l:'Compatible avec', t:'text', req:true, ph:'Ex : Toyota Corolla 2010-2015, universel',
      ...
      { k:'reference', l:'Référence constructeur', t:'text', ph:'Ex : 90915-YZZD4 (facultatif)',
        h:'La référence exacte rassure et fait remonter votre annonce dans la recherche.' },
      { k:'quantite', l:'Quantité disponible', t:'num', ph:'Ex : 4' },
  ...
  'Bateaux': {
    couleurs: true, etat: true, livraison: false,
    titre: function (S) { return [S.typeBateau, S.longueur, S.annee].filter(Boolean).join(' · ') },
    champs: [
      ...
      { k:'puissanceBat', l:'Puissance moteur', o:['Moins de 15 ch','15 à 40 ch','40 à 100 ch','100 à 200 ch','Plus de 200 ch'],
        when:function (S) { return S.moteurBat && S.moteurBat !== 'Sans moteur' } },
      { k:'annee', l:'Année', req:true, o:['2026','2025','2024','2023','2022','2021','2020','2019','2018','2017','2016','2015 et avant'] },
      { k:'heuresBat', l:'Heures moteur', t:'num', unite:'h', ph:'Ex : 900',
        h:function (S) {
          return moyenneAnnuelle(S, S.heuresBat, S.annee, 'heures', 150) ||
  ...
  'Location': {
    ...
    champs: [
      ...
      { k:'caution', l:'Caution demandée', t:'num', ph:'Ex : 200000', unite:'FCFA',
      ...
      { k:'zone', l:'Zone couverte', t:'text', ph:'Ex : Abidjan et intérieur du pays' },
