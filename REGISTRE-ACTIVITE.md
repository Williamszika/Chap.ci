...
| Livraisons | 926 |
| Jours travaillés | 70 |
| Dernière mise à jour | Samedi 19 septembre 2026, 14:28 (Abidjan) |
...
**23 livraison(s)** · Abidjan 09:43 → 13:43 · chez le Patron 11:43 → 15:43 · amplitude 4 h 00
...
- `10:58` · Registre d'activité et fiche de livraison du zip n° 35  <sub>`5ebdc54`</sub>
- `11:01` · La fiche du zip n° 35 porte la réponse du Patron sur l'ARTCI  <sub>`bd0b44b`</sub>
- `11:05` · Le zip n° 35 est extrait : la page confidentialité en ligne dit enfin vrai  <sub>`6c7421e`</sub>
...
- `11:56` · La page des fondateurs existait, mais le serveur ne l'appelait jamais  <sub>`046c42e`</sub>
- `12:01` · L'en-tête du .htaccess mentait depuis sept semaines  <sub>`84a44b5`</sub>
- `12:12` · Un bouton pour signaler les pages fixes à Bing, Yandex et Seznam  <sub>`cfa496f`</sub>
- `12:14` · Le registre note les cinq manœuvres du Patron de cette journée  <sub>`cc16847`</sub>
- `12:41` · Ne plus faire taper le Patron dans le .htaccess : lui donner le fichier entier  <sub>`d911cd7`</sub>
- `12:54` · Le registre garde la panne du 19/09, sa cause et son relèvement  <sub>`82e3b73`</sub>
- `13:43` · Deux empreintes SHA-256 sur la même page Play, et la plus visible est la mauvaise  <sub>`ea6ffd0`</sub>

### Vendredi 18 septembre 2026

**4 livraison(s)** · Abidjan 12:17 → 17:45 · chez le Patron 14:17 → 19:45 · amplitude 5 h 27
...
- `17:45` · Registre d'activité régénéré — 902 livraisons sur 69 jours  <sub>`ff9ec6d`</sub>

### Jeudi 17 septembre 2026

**4 livraison(s)** · Abidjan 19:18 → 21:57 · chez le Patron 21:18 → 23:57 · amplitude 2 h 39
...
- `21:57` · Registre d'activité régénéré — 898 livraisons sur 68 jours  <sub>`4dbd312`</sub>
...
- `02:44` · Un seul bouton dans la carte d’avis, et il dit où appuyer une fois sur le Play Store  <sub>`8fda19c`</sub>
...
**26 livraison(s)** · Abidjan 04:02 → 22:56 · chez le Patron 06:02 → 00:56 · amplitude 18 h 54
...
- `22:36` · « Noter sur le Play Store » existait déjà — et renvoyait les iPhone vers une fiche inutilisable  <sub>`0523f8c`</sub>
- `22:44` · Le rappel d’évaluation envoie sur le Play Store, et revient à chaque lancement  <sub>`5e37196`</sub>
- `22:48` · Fiche de build v1.26 — courte, parce qu’une fiche recopiée devient fausse  <sub>`8364154`</sub>
- `22:56` · La carte d’avis remplace « Soutenir Chap.ci » — et le serveur qui la rend possible part enfin  <sub>`af193d8`</sub>
