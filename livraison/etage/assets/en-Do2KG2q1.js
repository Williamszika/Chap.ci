const e={titre:"Privacy Policy",sousTitre:"How Chap.ci protects your data. Last updated: 23 July 2026.",avis:"This translation is provided for information only. In the event of any discrepancy, only the French version is authoritative.",sommaire:"Contents",intro:"Chap.ci (“the application”) is a classifieds platform in Côte d’Ivoire. This policy explains what data we collect, why, and how you stay in control. It is drawn up in accordance with Ivorian Law No. 2013-450 of 19 June 2013 on the protection of personal data.",sections:[{titre:"1. Data controller",texte:"The data controller is Chap.ci, publisher of the platform, reachable at contact@chap.ci. The data processing carried out by Chap.ci is subject to Law No. 2013-450 and to the formalities required by the ARTCI (Côte d’Ivoire’s Telecommunications/ICT Regulatory Authority), the personal-data protection authority."},{titre:"2. Data we collect",texte:`• Account: first name, last name, gender, date of birth, email address and/or phone number, profile photo (optional).
...
• Technical usage: preferences stored locally on your device (favourites, last position, read conversations).`},{titre:"3. How data is used, and consent",texte:`• Creating and managing your account, publishing and displaying listings.
...
Automatic photo analysis, on your phone. When you add a photo to a listing, it is examined by an image-recognition program in order to filter out sexual content, which our rules prohibit. This examination takes place entirely on your device, before anything is sent: the photo is not transmitted to any external service for analysis, no analysis result is kept, and nothing about you is inferred from it. If a photo is rejected, you are informed immediately and can choose another one. The recognition program ships with the application: it fetches nothing from the Internet and works even offline.`},{titre:"4. Location",texte:"Your position is used only to improve your experience (nearby listings, distances). You can refuse GPS access: the application then uses an approximate location based on your IP address. You can change this choice in your device’s settings at any time."},{titre:"5. Hosting, sharing and transfers",texte:`Your data is stored on our own server hosted in Côte d’Ivoire (host: TPE Cloud), in a secured database. We do not sell and do not rent your personal data. We rely on a limited number of providers:
...
These transfers to third countries are limited to what is strictly necessary for the service to work, and carried out in compliance with the conditions set by Law No. 2013-450 (an adequate level of protection and, where applicable, ARTCI authorisation). Your account data, your listings, your photos and your messages, for their part, do not leave Côte d’Ivoire.`},{titre:"6. Retention and deletion",texte:`Your data is kept as long as your account is active, and no longer than necessary for the purposes for which it was collected. You can delete your account at any time from Account → Settings → Delete my account. Deletion permanently erases your profile, your listings, your orders, your messages and your reviews.
...
Both purges are automatic and daily. You can also request deletion from the account-deletion page, without being signed in.`},{titre:"7. Security",texte:"Passwords are encrypted (bcrypt hashing) and are never stored in clear text. SMS verification codes are single-use, short-lived and stored in encrypted form. Access to data is checked server-side on every request (each person only reaches their own data). Exchanges with the site are protected by HTTPS. We take reasonable technical and organisational measures to preserve the confidentiality and integrity of your data, in accordance with Law No. 2013-450."},{titre:"8. Minors",texte:"The application is not intended for people under 18. We do not knowingly collect data from minors."},{titre:"9. Your rights (Law No. 2013-450)",texte:`In accordance with Ivorian Law No. 2013-450 on the protection of personal data, you have the following rights:
...
To exercise these rights, use the application or write to us at contact@chap.ci. We answer as promptly as possible. If you consider that your rights are not respected, you can refer the matter to the ARTCI (artci.ci), the personal-data protection authority in Côte d’Ivoire.`},{titre:"10. Legal framework",texte:`This policy falls within the framework of the following texts:
...
• the ARTCI regulations applicable to data processing.`},{titre:"11. Cookies and advertising measurement",texte:`On the chap.ci website, in addition to the cookies strictly necessary for operation (sign-in, preferences), we use audience-measurement and advertising tools that set cookies or identifiers:
...
Your choices: you can refuse or limit these trackers at any time — by blocking cookies in your browser, through each platform’s advertising settings (Google, Meta, TikTok), or by enabling “Limit ad tracking” in your phone’s settings. Refusing does not prevent you from using Chap.ci. These trackers are not active in the mobile application.`},{titre:"12. Contact",texte:"For any question about this policy: contact@chap.ci."}]};export{e as politique};
